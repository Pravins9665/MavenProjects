package Reusablecodesofselenium;
...
public class Utils {
	...
	public static void mousehover(WebDriver driver, String hoverOP, WebElement element, WebElement element1, Integer x,
			Integer y) {
	...
	public static void dropdown(WebDriver driver, String dd, WebElement element, Integer num, String text,
			String value) {
	...
	// option selection
	public static void dropdown1(WebDriver driver, List<WebElement> options, String value) {
	...
	// choices
	public static void dropdown2(WebDriver driver, String xpath, String... value) {
	...
	public static void Checkbox(WebDriver driver, List<WebElement> checkboxex, String txt) {
	...
	public static void calendar(WebDriver driver, String month, String year, String xpathofmonthyear,
			String xpathnextmonthyear) {
		while (true) {
	...
	public static void pickdate(WebDriver driver, String day, List<WebElement> alldates) {
